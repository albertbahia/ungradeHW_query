...
SELECT step7.[unit], step7.[title], step7.[class section], COUNT(*) AS ungradedAmount
	FROM(
...
GROUP BY step7.[unit], step7.[title], step7.[class section]
ORDER BY ungradedAmount DESC
